% pop_eegfilt2() - interactively filter EEG dataset data using eegfilt()
%
% Usage:
...
function [EEG, com] = pop_eegfilt2( EEG, locutoff, hicutoff, filtorder, revfilt, usefft, plotfreqz, firtype, causal)

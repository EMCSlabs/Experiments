% pop_chanedit2() - Edit the channel locations structure of an EEGLAB dataset,
...
function [chansout, chaninfo, urchans, com] = pop_chanedit2(chans, orichaninfo, varargin);
